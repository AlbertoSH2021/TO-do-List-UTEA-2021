...
<head>
	...
	<style>
		...
		.formulariowtsp{
			...
			background: rgba(214, 216, 216, 0.651);
			padding: 5px 10px;
			display: none;
			font-size: 15px;
		}
...
<!-- ChatBot -->
<div class="chat_icon">
	<img src="../galeria/images/robot.png" alt="" class="fa fa-comments" aria-hidden="true" width="75px">
...
<h1 id="title-1">
	<div class="wrap icon"> 
	<i class="fa fa-cog fa-spin"></i> <i class="fa fa-spin-reverse fa-cog"></i> <i class="fa fa-cog fa-spin"></i> <h1>Ingieneria de Software 2</h2><img src="../images/descarga.png"  width="100px" ><img src="../images/img slider/utea.png" alt="" width="75px" class="">
	</div>
  <em><span><img src="../galeria/images/tierra.png" width="39px" class="fa-spin"></span><img src="../galeria/images/planeta (1).png " width="15px" ><span></span>
	<img src="../galeria/images/negro.png" class="fa-spin-reverse" width="30px"><img src="../images/img slider/dom.png" class="fa-spin-reverse" width="50px"></span><img src="../images/img slider/dom.png" class="fa-spin-reverse" width="10px"><span><img src="../galeria/images/negros.png" class="fa-spin-reverse" width="20px">
	  </span><img src="../galeria/images/negros.png" width="190px" class="fa-spin-reverse"><span><img src="../galeria/images/img.png " width="10px" class="fa-spin-reverse"></span><img src="../images/img slider/dom.png" class="fa-spin-reverse" width="10px"><img src="../galeria/images/negro.png" class="fa-spin-reverse" width="20px">
	  <span><img src="../galeria/images/negros.png" class="fa-spin-reverse" width="9px"></span><img src="../images/img slider/dom.png" width="80px"><span><img src="../galeria/images/venus.png" width="8px" class="fa-spin"></span>
	<img src="../galeria/images/hi.png" class="fa-spin-reverse" width="75px"></em>
  <img src="" alt="">
</h1>
<!--  -->

<p class="parrafo" id="title-1"><em><span> </span>Alberto</em><em><span></span></em></div></h1></p>
