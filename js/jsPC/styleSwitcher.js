...
(function ($) {
    ...
    var mainAppNew = {
        ...
        main_fun: function () {
            ...
            $('#pink').click(function () {
                $('#mainCSS').attr('href', 'css/cssPC/themes/pink.css');
            });
            $('#green').click(function () {
                $('#mainCSS').attr('href', 'css/cssPC/themes/green.css');
            });
            $('#blue').click(function () {
                $('#mainCSS').attr('href', 'css/cssPC/themes/blue.css');
            });
            $('#brown').click(function () {
                $('#mainCSS').attr('href', 'css/cssPC/themes/brown.css');
            });
